...
function mostrarMensajeExito(listado) {
    ...
    if (listado.length === 0 ) {
        ...
        cajaExito.setAttribute( "id" , "exito" );
        cajaExito.style = "background:rgba(0, 255, 0, 0.2);padding:.5em 1em;color: green;margin: .5em 0;";
        cajaExito.innerHTML = `<p><small>¡Formulario completado con éxito!</small></p>`;
